...
from flag_attn.runtime.backend._enflame.gdn2 import chunk_gdn2
from flag_attn.runtime.backend._enflame.gdn2.native.chunk_fwd import (
    chunk_gdn2_fwd,
)

FORCE_NATIVE_ENV = "FLAG_ATTN_GDN2_FORCE_NATIVE"
...
def _public_gdn2_op(*args, **kwargs):
    ...
    if not force_native and module.HAS_TLE_GDN2:
...
@pytest.mark.skipif(
    not (hasattr(torch, "gcu") and torch.gcu.is_available()),
    reason="chunk_gdn2 benchmark requires an available Enflame GCU",
)
