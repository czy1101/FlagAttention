...
from flag_attn.gated_delta_rule.triton_ops_helper import autotune_cache_kwargs, exp, log

from ..gated_linear_attention.index import (
...
@triton.autotune(
    configs=[triton.Config({"BC": bc}, num_warps=num_warps) for bc in [64, 32, 16] for num_warps in [1, 2, 4]],
    key=["BS", "BK", "BV"],
