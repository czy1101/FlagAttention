...
@triton.jit
def _compute_mtp4___fp8_kvpertensor_decode_mtp4_pure_tle_task(Q, K_DESC, VT_DESC, BLOCK_IDS, TASK_MAP, SEQLENS_KV, QSCALE, KSCALE, VSCALE, SPLIT_OUT, LSE, COMPLETION, LAST_FLAGS, OUT, KV_READER, Q_REUSE_SMEM, LOCAL_ACC_SMEM, LOCAL_LSE_SMEM, cta, copy_iter_base, mesh: tl.constexpr, B: tl.constexpr, H_Q: tl.constexpr, HEADS_PER_GROUP: tl.constexpr, D: tl.constexpr, DV: tl.constexpr, BLOCK_SIZE: tl.constexpr, MAX_BLOCKS: tl.constexpr, BLOCK_N: tl.constexpr, Q_STRIDE_B: tl.constexpr, Q_STRIDE_M: tl.constexpr, Q_STRIDE_H: tl.constexpr, QS_STRIDE_B: tl.constexpr, QS_STRIDE_M: tl.constexpr, QS_STRIDE_H: tl.constexpr, SO_STRIDE_B: tl.constexpr, SO_STRIDE_C: tl.constexpr, SO_STRIDE_M: tl.constexpr, SO_STRIDE_H: tl.constexpr, LSE_STRIDE_B: tl.constexpr, LSE_STRIDE_C: tl.constexpr, LSE_STRIDE_HKV: tl.constexpr, LSE_STRIDE_M: tl.constexpr, LSE_STRIDE_HG: tl.constexpr, O_STRIDE_B: tl.constexpr, O_STRIDE_M: tl.constexpr, O_STRIDE_H: tl.constexpr, LDSM_REGISTER_SHARED: tl.constexpr=False, WIDE_VIEW_V_RS: tl.constexpr=False, MERGE_CLUSTER_SIZE: tl.constexpr=8, EXECUTION_STAGE: tl.constexpr=_compute_mtp4__EXECUTION_FULL, MAX_FINAL_CHUNKS: tl.constexpr=16, PAIRED_HEAD_FINALIZE: tl.constexpr=False, QUAD_HEAD_TWO_CHUNK_FINALIZE: tl.constexpr=False, FAST_FINALIZER_HANDOFF: tl.constexpr=False, RANK0_ONLY_FINALIZER: tl.constexpr=False, SKIP_TRAILING_FINALIZER_BARRIER: tl.constexpr=False, C4_FINALIZER_TILE: tl.constexpr=1, KS_STRIDE_BLOCK: tl.constexpr=0, KS_STRIDE_TOKEN: tl.constexpr=0, KS_STRIDE_HEAD: tl.constexpr=0, KS_STRIDE_D: tl.constexpr=0, PREFETCH_K_SCALE: tl.constexpr=False, PRECOMBINE_Q_SCALE: tl.constexpr=False, STATIC_SCHED: tl.constexpr=False, STATIC_CHUNK_TOKENS: tl.constexpr=0, STATIC_MAX_GROUPS: tl.constexpr=1):
    ...
    SHARED_K_SCALE_PIPELINE: tl.constexpr = PREFETCH_K_SCALE == 3
    WGMMA_SHADOW_K_SCALE: tl.constexpr = PREFETCH_K_SCALE == 4
...
@triton.jit
def _compute_mtp4__fp8_kvpertensor_decode_mtp4_pure_tle_kernel(Q, K_DESC, VT_DESC, BLOCK_IDS, TASK_MAP, SEQLENS_KV, QSCALE, KSCALE, VSCALE, SPLIT_OUT, LSE, COMPLETION, LAST_FLAGS, OUT, mesh: tl.constexpr, B: tl.constexpr, H_Q: tl.constexpr, HEADS_PER_GROUP: tl.constexpr, D: tl.constexpr, DV: tl.constexpr, BLOCK_SIZE: tl.constexpr, MAX_BLOCKS: tl.constexpr, BLOCK_N: tl.constexpr, Q_STRIDE_B: tl.constexpr, Q_STRIDE_M: tl.constexpr, Q_STRIDE_H: tl.constexpr, QS_STRIDE_B: tl.constexpr, QS_STRIDE_M: tl.constexpr, QS_STRIDE_H: tl.constexpr, SO_STRIDE_B: tl.constexpr, SO_STRIDE_C: tl.constexpr, SO_STRIDE_M: tl.constexpr, SO_STRIDE_H: tl.constexpr, LSE_STRIDE_B: tl.constexpr, LSE_STRIDE_C: tl.constexpr, LSE_STRIDE_HKV: tl.constexpr, LSE_STRIDE_M: tl.constexpr, LSE_STRIDE_HG: tl.constexpr, O_STRIDE_B: tl.constexpr, O_STRIDE_M: tl.constexpr, O_STRIDE_H: tl.constexpr, LDSM_REGISTER_SHARED: tl.constexpr=False, WIDE_VIEW_V_RS: tl.constexpr=False, MERGE_CLUSTER_SIZE: tl.constexpr=8, EXECUTION_STAGE: tl.constexpr=_compute_mtp4__EXECUTION_FULL, MAX_FINAL_CHUNKS: tl.constexpr=16, PAIRED_HEAD_FINALIZE: tl.constexpr=False, QUAD_HEAD_TWO_CHUNK_FINALIZE: tl.constexpr=False, FAST_FINALIZER_HANDOFF: tl.constexpr=False, RANK0_ONLY_FINALIZER: tl.constexpr=False, SKIP_TRAILING_FINALIZER_BARRIER: tl.constexpr=False, PDL_NOTIFY: tl.constexpr=False, C4_FINALIZER_TILE: tl.constexpr=1, KS_STRIDE_BLOCK: tl.constexpr=0, KS_STRIDE_TOKEN: tl.constexpr=0, KS_STRIDE_HEAD: tl.constexpr=0, KS_STRIDE_D: tl.constexpr=0, PREFETCH_K_SCALE: tl.constexpr=False, PRECOMBINE_Q_SCALE: tl.constexpr=False, STATIC_SCHED: tl.constexpr=False, STATIC_CHUNK_TOKENS: tl.constexpr=0, STATIC_MAX_GROUPS: tl.constexpr=1):
...
def _runtime_mtp4__fp8_kvpertensor_decode_mtp4_c2_bf16_dsm_specialized(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace, *, page_metadata_k_scale: bool, precombine_q_scale: bool, aligned_full_chunk_winner: bool) -> torch.Tensor:
...
def _runtime_mtp4__fp8_kvpertensor_decode_mtp4_detached_raw_finalize(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace, *, use_pdl: bool, maxnreg: int | None, page_metadata_k_scale: bool, precombine_q_scale: bool, reduction_only_raw: bool, aligned_full_chunk_raw: bool) -> torch.Tensor:
    ...
    reducer_kwargs = dict(B=inputs.num_batch, H_Q=num_head_q, HEADS_PER_GROUP=ws.heads_per_group, D=_runtime__HEAD_DIM, CHUNK_TOKENS=ws.config.chunk_tokens, MAX_FINAL_CHUNKS=triton.next_power_of_2(ws.schedule.partial_slots), HEAD_PASSES=head_passes, SO_STRIDE_B=ws.split_out.stride(0), SO_STRIDE_C=ws.split_out.stride(1), SO_STRIDE_M=ws.split_out.stride(2), SO_STRIDE_H=ws.split_out.stride(3), LSE_STRIDE_B=ws.lse.stride(0), LSE_STRIDE_C=ws.lse.stride(1), LSE_STRIDE_HKV=ws.lse.stride(2), LSE_STRIDE_M=ws.lse.stride(3), LSE_STRIDE_HG=ws.lse.stride(4), O_STRIDE_B=ws.out.stride(0), O_STRIDE_M=ws.out.stride(1), O_STRIDE_H=ws.out.stride(2), V_PER_HEAD=False, PDL_WAIT=use_pdl, num_warps=4, num_stages=1, launch_pdl=use_pdl)
...
def _runtime_mtp4__fp8_kvpertensor_decode_mtp4_final(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace) -> torch.Tensor:
    ...
    precombine_static_scale = not (workspace.config.cluster_size == 4 and workspace.config.chunk_tokens == 128)
    if resolved == 'winner':
    ...
    if resolved == 'c2-raw':
        ...
        return _runtime_mtp4__fp8_kvpertensor_decode_mtp4_c2_bf16_dsm_specialized(inputs, workspace, page_metadata_k_scale=None, precombine_q_scale=None, aligned_full_chunk_winner=aligned_c2)
    if resolved in ('pdl', 'pdl-s'):
        producer_maxnreg = 240
        aligned_c4 = workspace.config in (_runtime_mtp4__C4_T512, _runtime_mtp4__C4_T1024) and workspace.all_chunks_aligned and (not int(workspace.stats.get('direct_tasks', 0))) and (not int(workspace.stats.get('dummy_tasks', 0))) and (not workspace.config.subgroup2_threshold) and (workspace.config == _runtime_mtp4__C4_T512 and resolved == 'pdl' or (workspace.config == _runtime_mtp4__C4_T1024 and resolved in ('pdl', 'pdl-s')))
        aligned_reduction_only = aligned_c4 and workspace.config == _runtime_mtp4__C4_T512
        return _runtime_mtp4__fp8_kvpertensor_decode_mtp4_detached_raw_finalize(inputs, workspace, use_pdl=True, maxnreg=producer_maxnreg, reduction_only_raw=aligned_reduction_only, aligned_full_chunk_raw=aligned_c4, page_metadata_k_scale=None, precombine_q_scale=aligned_c4)
...
def _static_mtp1__fp8_kvpertensor_decode_mtp1_static(inputs: _runtime_mtp1__DecodeInputs, workspace: _static_mtp1__StaticDecodeWorkspace, *, no_causal_mask: bool, block_ids_prefetch: bool, paired_head_finalize: bool | None, bf16_dsm: bool | None, deferred_norm: bool | None, election_mode: str | None, precombine_q_scale: bool | None, skip_trailing_finalizer_barrier: bool | None, c2_raw: bool | None, tma_k_scale: bool | None, page_metadata_k_scale: bool, flatten_output: bool) -> torch.Tensor:
    ...
    _compute_mtp1__fp8_kvpertensor_decode_mtp1_final_kernel[logical_clusters,](ws.q_4d, k_desc, v_desc, inputs.block_ids, inputs.kv_lens, ws.q_scale_3d, inputs.k_scale, inputs.v_scale, ws.split_out, ws.lse, ws.completion, ws.last_flags, ws.out, mesh=_runtime__CLUSTER_MESHES[cluster_size], B=inputs.num_batch, H_Q=num_head_q, HEADS_PER_GROUP=heads_per_group, D=_runtime__HEAD_DIM, DV=_runtime__HEAD_DIM, BLOCK_SIZE=_runtime__BLOCK_SIZE, MAX_BLOCKS=inputs.block_ids.shape[1], BLOCK_N=_runtime__TILE_N, Q_STRIDE_B=ws.q_4d.stride(0), Q_STRIDE_M=ws.q_4d.stride(1), Q_STRIDE_H=ws.q_4d.stride(2), QS_STRIDE_B=ws.q_scale_3d.stride(0), QS_STRIDE_M=ws.q_scale_3d.stride(1), QS_STRIDE_H=ws.q_scale_3d.stride(2), SO_STRIDE_B=ws.split_out.stride(0), SO_STRIDE_C=ws.split_out.stride(1), SO_STRIDE_M=ws.split_out.stride(2), SO_STRIDE_H=ws.split_out.stride(3), LSE_STRIDE_B=ws.lse.stride(0), LSE_STRIDE_C=ws.lse.stride(1), LSE_STRIDE_HKV=ws.lse.stride(2), LSE_STRIDE_M=ws.lse.stride(3), LSE_STRIDE_HG=ws.lse.stride(4), O_STRIDE_B=ws.out.stride(0), O_STRIDE_M=ws.out.stride(1), O_STRIDE_H=ws.out.stride(2), PAGE_METADATA_K_SCALE=page_metadata_k_scale, PRECOMBINE_Q_SCALE=precombine_q_scale, LDSM_REGISTER_SHARED=not use_c2_raw, FULL_VIEW_V_RS=use_c2_raw, MERGE_CLUSTER_SIZE=cluster_size, EXECUTION_STAGE=_compute_mtp1__EXECUTION_FULL, MAX_FINAL_CHUNKS=triton.next_power_of_2(ws.max_groups), PAIRED_HEAD_FINALIZE=paired_finalize, BF16_DSM=bf16_dsm, DEFERRED_NORM=deferred_norm, DSM_ELECTION_HANDOFF=dsm_handoff and (not use_c2_raw), DETERMINISTIC_TAIL_ELECTION=deterministic_tail and (not use_c2_raw), RANK0_ONLY_FINALIZER=use_c2_raw, REDUCTION_ONLY=ws.reduction_only, SKIP_TRAILING_FINALIZER_BARRIER=skip_trailing_finalizer_barrier, STATIC_CHUNK_TOKENS=config.chunk_tokens, STATIC_MAX_GROUPS=ws.max_groups, STATIC_MTP1_NO_CAUSAL_MASK=no_causal_mask, STATIC_BLOCK_IDS_PREFETCH=block_ids_prefetch, ALIGNED_FULL_CHUNK_TOKENS=ws.aligned_chunk_tokens, num_ctas=1, num_warps=4, num_stages=3, launch_pdl=False)
    if flatten_output:
...
def _static_mtp2__fp8_kvpertensor_decode_mtp2_static(inputs: _runtime_mtp2__DecodeInputs, workspace: _static_mtp2__StaticDecodeWorkspace, *, paired_head_finalize: bool | None, bf16_dsm: bool | None, deferred_norm: bool | None, election_mode: str | None, tail_only_election_barrier: bool, precombine_q_scale: bool | None, skip_trailing_finalizer_barrier: bool | None, full_view_dsm: bool, full_view_v_rs: bool | None, c2_raw: bool | None, tma_k_scale: bool | None, page_metadata_k_scale: bool, flatten_output: bool) -> torch.Tensor:
    ...
    logical_clusters = inputs.num_batch * num_head_kv * ws.max_groups
    _compute_mtp2__fp8_kvpertensor_decode_mtp2_final_kernel[logical_clusters,](ws.q_4d, k_desc, v_desc, inputs.block_ids, inputs.kv_lens, ws.q_scale_3d, inputs.k_scale, inputs.v_scale, ws.split_out, ws.lse, ws.completion, ws.last_flags, ws.out, mesh=_runtime__CLUSTER_MESHES[cluster_size], B=inputs.num_batch, H_Q=num_head_q, HEADS_PER_GROUP=heads_per_group, D=_runtime__HEAD_DIM, DV=_runtime__HEAD_DIM, BLOCK_SIZE=_runtime__BLOCK_SIZE, MAX_BLOCKS=inputs.block_ids.shape[1], BLOCK_N=_runtime__TILE_N, Q_STRIDE_B=ws.q_4d.stride(0), Q_STRIDE_M=ws.q_4d.stride(1), Q_STRIDE_H=ws.q_4d.stride(2), QS_STRIDE_B=ws.q_scale_3d.stride(0), QS_STRIDE_M=ws.q_scale_3d.stride(1), QS_STRIDE_H=ws.q_scale_3d.stride(2), SO_STRIDE_B=ws.split_out.stride(0), SO_STRIDE_C=ws.split_out.stride(1), SO_STRIDE_M=ws.split_out.stride(2), SO_STRIDE_H=ws.split_out.stride(3), LSE_STRIDE_B=ws.lse.stride(0), LSE_STRIDE_C=ws.lse.stride(1), LSE_STRIDE_HKV=ws.lse.stride(2), LSE_STRIDE_M=ws.lse.stride(3), LSE_STRIDE_HG=ws.lse.stride(4), O_STRIDE_B=ws.out.stride(0), O_STRIDE_M=ws.out.stride(1), O_STRIDE_H=ws.out.stride(2), PAGE_METADATA_K_SCALE=page_metadata_k_scale, PRECOMBINE_Q_SCALE=precombine_q_scale, LDSM_REGISTER_SHARED=not full_view_v_rs, FULL_VIEW_V_RS=full_view_v_rs, MERGE_CLUSTER_SIZE=cluster_size, EXECUTION_STAGE=_compute_mtp2__EXECUTION_FULL, MAX_FINAL_CHUNKS=triton.next_power_of_2(ws.max_groups), REUSE_FINAL_WEIGHTS=not use_c2_raw, PAIRED_HEAD_FINALIZE=paired_finalize, BF16_DSM=bf16_dsm, DEFERRED_NORM=deferred_norm, DSM_ELECTION_HANDOFF=dsm_handoff, DETERMINISTIC_TAIL_ELECTION=deterministic_tail, TAIL_ONLY_ELECTION_BARRIER=tail_only_election_barrier, REDUCTION_ONLY=reduction_only, ALIGNED_FULL_CHUNK_TOKENS=chunk_tokens if auto_aligned else 0, FULL_VIEW_DSM=full_view_dsm, RANK0_ONLY_FINALIZER=use_c2_raw, SKIP_TRAILING_FINALIZER_BARRIER=skip_trailing_finalizer_barrier, STATIC_CHUNK_TOKENS=chunk_tokens, STATIC_MAX_GROUPS=ws.max_groups, num_ctas=1, num_warps=4, num_stages=3, launch_pdl=False)
    if flatten_output:
...
def _static_mtp4___run_static_winner_route(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace, *, full_view_v: bool) -> torch.Tensor:
    config = workspace.config
    ...
    return _runtime_mtp4__fp8_kvpertensor_decode_mtp4_pure_tle(inputs, workspace, paired_head_finalize=use_c4 or use_general_c2_quad, direct_fast_path=True, quad_head_two_chunk_finalize=use_c2_exact_two, fast_finalizer_handoff=use_c4 or use_c2_sharded_quad, rank0_only_finalizer=use_c2_exact_two or use_c2_rank0_quad, skip_trailing_finalizer_barrier=use_c4 or use_c2_exact_two or use_general_c2_quad, maxnreg=240 if use_c4 else None, precombine_q_scale=precombine, c2_aligned_full_chunk_winner=aligned_c2, full_view_v_rs=full_view_v, execution_stage='full', c4_bf16_dsm=False, c4_deferred_norm=False, c4_global_deferred_norm=False, c4_reduction_only_raw=False, c4_aligned_full_chunk_raw=False, pdl_notify=False, prefetch_k_scale=False, page_metadata_k_scale=False, tma_k_scale=False, flatten_output=True)

def _static_mtp4___run_static_pdl_route(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace, *, use_pdl: bool, maxnreg: int) -> torch.Tensor:
    aligned = workspace.config.cluster_size == 4 and workspace.config.chunk_tokens in (512, 1024) and workspace.all_chunks_aligned
    reduction_only = aligned and workspace.config.chunk_tokens == 512
    return _runtime_mtp4__fp8_kvpertensor_decode_mtp4_detached_raw_finalize(inputs, workspace, use_pdl=use_pdl, maxnreg=maxnreg, precombine_q_scale=True, reduction_only_raw=reduction_only, aligned_full_chunk_raw=aligned, page_metadata_k_scale=False)

def _static_mtp4__fp8_kvpertensor_decode_mtp4_static_tuned(inputs: _runtime_mtp4__DecodeInputs, workspace: _runtime_mtp4__DecodeWorkspace, *, route: str) -> torch.Tensor:
    ...
    if route == 'noalign':
        ...
        return _runtime_mtp4__fp8_kvpertensor_decode_mtp4_c2_bf16_dsm_specialized(inputs, workspace, precombine_q_scale=True, aligned_full_chunk_winner=False, page_metadata_k_scale=False)
    if route == 'nopdl':
...
_fp8_entry___STATIC_Q1_CT = {1: {'uniform_512': (2, 256), 'uniform_4096': (2, 1024), 'skewed_mix': (8, 512), 'skewed_extreme': (4, 128), 'one_64k_7x4k': (4, 256), 'one_64k_15x4k': (8, 512), 'one_64k_31x4k': (8, 512), 'one_128k_31x4k': (4, 1024), 'two_32k_30x4k': (8, 512)}, 2: {'uniform_512': (2, 256), 'uniform_4096': (2, 1024), 'skewed_mix': (2, 512), 'skewed_extreme': (4, 128), 'one_64k_7x4k': (4, 256), 'one_64k_15x4k': (8, 512), 'one_64k_31x4k': (4, 512), 'one_128k_31x4k': (4, 1024), 'two_32k_30x4k': (4, 512)}, 4: {'uniform_512': (2, 256), 'uniform_4096': (2, 1024), 'skewed_mix': (2, 512), 'skewed_extreme': (4, 128), 'one_64k_7x4k': (4, 512), 'one_64k_15x4k': (4, 512), 'one_64k_31x4k': (4, 1024), 'one_128k_31x4k': (4, 1024), 'two_32k_30x4k': (4, 1024)}}
...
def _fp8_entry___route(mtp: int, case: str, layout: str) -> str:
    if mtp == 1:
        return {'uniform_512': 'prefetch-qscale', 'uniform_4096': 'barrier-sink', 'skewed_mix': 'default', 'skewed_extreme': 'prefetch', 'one_64k_7x4k': 'barrier-sink', 'one_64k_15x4k': 'default', 'one_64k_31x4k': 'prefetch', 'one_128k_31x4k': 'prefetch', 'two_32k_30x4k': 'prefetch'}[case]
    if mtp == 2:
...
def _fp8_entry___mtp1_options(policy: _fp8_entry__FP8DecodePolicy) -> dict[str, object]:
    ...
    return {'uniform_512': dict(no_causal_mask=True, block_ids_prefetch=True, precombine_q_scale=True), 'uniform_4096': dict(no_causal_mask=True, block_ids_prefetch=True, skip_trailing_finalizer_barrier=True), 'skewed_mix': dict(no_causal_mask=False, block_ids_prefetch=False), 'skewed_extreme': dict(no_causal_mask=True, block_ids_prefetch=True), 'one_64k_7x4k': dict(no_causal_mask=True, block_ids_prefetch=False, skip_trailing_finalizer_barrier=True), 'one_64k_15x4k': dict(no_causal_mask=False, block_ids_prefetch=False), 'one_64k_31x4k': dict(no_causal_mask=True, block_ids_prefetch=True, precombine_q_scale=False), 'one_128k_31x4k': dict(no_causal_mask=True, block_ids_prefetch=True), 'two_32k_30x4k': dict(no_causal_mask=True, block_ids_prefetch=True, precombine_q_scale=False)}[case]
...
_fp8_entry___MTP4_Q1_ROUTES = {('uniform_512', 'NHD'): 'full_v', ('uniform_512', 'HND'): 'full_v', ('uniform_4096', 'NHD'): 'noalign', ('uniform_4096', 'HND'): 'noalign', ('skewed_mix', 'NHD'): 'default', ('skewed_mix', 'HND'): 'full_v', ('skewed_extreme', 'NHD'): 'full_v', ('skewed_extreme', 'HND'): 'full_v', ('one_64k_7x4k', 'NHD'): 'default', ('one_64k_7x4k', 'HND'): 'default', ('one_64k_15x4k', 'NHD'): 'nopdl', ('one_64k_15x4k', 'HND'): 'nopdl', ('one_64k_31x4k', 'NHD'): 'default', ('one_64k_31x4k', 'HND'): 'default', ('one_128k_31x4k', 'NHD'): 'scalar_major', ('one_128k_31x4k', 'HND'): 'scalar_major', ('two_32k_30x4k', 'NHD'): 'r192', ('two_32k_30x4k', 'HND'): 'default'}
