"""A41-L0: mixed BF16-QK / FP16-PV global-gauge TLE attention kernel."""
...
def consumer(output, lse, q_smem, p_smem, q_full, k_stages, v_stages,
             ...
             QK_IS_BF16: tl.constexpr, PV_IS_BF16: tl.constexpr,
...
def consumer0(output, lse, q0, p0, q0_full, k_stages, v_stages,
              ...
              BM_VALUE: tl.constexpr, BN_VALUE: tl.constexpr,
              CAPACITY_VALUE: tl.constexpr, QK_IS_BF16: tl.constexpr,
              PV_IS_BF16: tl.constexpr, OUTPUT_IS_BF16: tl.constexpr):
    consumer(
        ...
        QK_IS_BF16, PV_IS_BF16, OUTPUT_IS_BF16,
    )
    ...
    tle.gpu.warp_specialize(
        [
            ...
            (consumer0, (output, lse, q0, p0, q0_full, k_stages, v_stages,
                         ...
                         CAPACITY_VALUE, QK_IS_BF16, PV_IS_BF16,
                         OUTPUT_IS_BF16)),
...
def launch(q_cache, k_cache, v, output, lse, capacity: int, scale=None):
